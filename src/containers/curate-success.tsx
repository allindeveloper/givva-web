...
export const CurrateSuccess = ({
    ...
    return (
        <>
            ...
            <div className="mt-20">
                <ButtonAtom onClick={handleGoHome} title="Go home" className="!bg-blue-custom-1 text-center w-full" />

                <ButtonAtom onClick={handleViewDetails} title="View details" className="!bg-grey-custom-5 !text-dark-custom-5 mt-5 text-center w-full" />
            </div>
